...
class OopTv(QWidget):
    ...
    """
    def __init__(self, names, pixmaps, title, geometry, debug):
...
options = {'debug': args.verbose, 'geometry': args.geometry,
           'title': args.name}
...
folder = 'img/'
names = ('tvfg.png', 'white_noise.jpg', 'guido.png', 'ricky.jpg', 'johnny.jpg')
pixmaps = []
